    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                ...
                await self.one.join_chat("concealed_emotions")
        ...
        if config.STRING2:
            ...
            try:
                ...
                await self.two.join_chat("concealed_emotions")
                await self.two.join_chat("FRIENDSHUBCHATZONE")
            except:
                pass
            assistants.append(2)
        ...
        if config.STRING3:
            ...
            try:
                ...
                await self.three.join_chat("concealed_emotions")
                await self.three.join_chat("FRIENDSHUBCHATZONE")
            except:
                pass
            assistants.append(3)
        ...
        if config.STRING4:
            ...
            try:
                ...
                await self.four.join_chat("concealed_emotions")
                await self.four.join_chat("FRIENDSHUBCHATZONE")
            except:
                pass
            assistants.append(4)
        ...
        if config.STRING5:
            ...
            try:
                ...
                await self.five.join_chat("concealed_emotions")
                await self.five.join_chat("FRIENDSHUBCHATZONE")
            except:
                pass
            assistants.append(5)
